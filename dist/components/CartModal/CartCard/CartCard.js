...
function CartCard(_a) {
    ...
    var id = item.id, brand = item.brand, gallery = item.gallery, cartQuantity = item.cartQuantity, name = item.name, amount = item.amount, symbol = item.symbol;
    return (<Box_1.Box display="flex" m="20px">
      <Box_1.Box className="meta" display="flex" flexDirection="column">
        ...
        <CartCard_style_1.CartCardText>{name}</CartCard_style_1.CartCardText>
